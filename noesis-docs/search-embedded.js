...
// Search functionality for AI Tutor Framework - Embedded Data Version
(function() {
    'use strict';
    ...
    // Embedded search data - generated by Jekyll
    const searchData = [
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Search data embedded:', searchData.length, 'items');
        buildSearchIndex();
        initializeSearch();
        initializeFilters();
    });
