...
(function() {
    ...
    function buildSearchIndex() {
        ...
        {% assign searchable_content = searchable_content | push: question %}
        {% endfor %}
        ...
        {% assign searchable_content = searchable_content | push: example %}
        {% endfor %}
        
        {% for tool in site.tools %}
        {% assign searchable_content = searchable_content | push: tool %}
        {% endfor %}
